-------------------------------------------------------------------------
title: LeNet MNIST User Documentation
description: Train and test "LeNet" on the MNIST handwritten digit data.
This Readme.md has been modified for our folder structures
-------------------------------------------------------------------------

# Training LeNet on MNIST with Caffe

Caffe has to be compiled. If not, please refer to the [Installation page](/installation.html). Assume that your Caffe installation is located at `CAFFE_ROOT`.
...
If it complains that `wget` or `gunzip` are not installed, you need to install them respectively. After running the script there should be two datasets (folders), `mnist_train_lmdb`, and `mnist_test_lmdb`.
